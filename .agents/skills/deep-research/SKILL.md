...
Start from the question, audience, scope, and output type already supplied. Ask only when missing information cannot be reasonably inferred and would materially change the research or deliverable. Use an available, permitted user-input tool, or ask in the conversation when needed. Preserve any specified output format; offer formats only when that choice remains material and unresolved. When information is sufficient, begin research directly and state any necessary assumptions. Continue independent research while awaiting an answer.
