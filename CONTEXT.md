...
Domain schema 10; Store schema 16; canonical Contract 40; Prompt bundle 24; freshness candidate 41; Outcome metric basis v3; evaluation context v1; benchmark definition v1 unchanged. These name current code semantics. See [implementation handoff](docs/task1-repair-handoff.md) and [Task 2 debug entrypoints](docs/task2-debug.md) for compatibility and the distinction between implementation checks and complete runtime evidence.
