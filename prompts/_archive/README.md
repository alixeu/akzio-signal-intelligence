...
| `phase2/researcher/warmup.md` / `debate.md` | shared warm-up plus kind-selected Bull/Bear seed/debate packets; `side_bull.md` and `side_bear.md` supply the strategy delta |
