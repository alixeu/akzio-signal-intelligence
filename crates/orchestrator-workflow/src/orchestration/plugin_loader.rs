...
use orchestrator_core::plugin_manifest::{ComponentManifest, RoleManifest};
use std::collections::{BTreeMap, BTreeSet};
use std::path::{Path, PathBuf};

const KNOWN_RENDER_VARIABLES: &[&str] = &[
    "ticker",
    "tickers",
...
#[derive(Debug, Clone, Default)]
pub(crate) struct RolePluginRegistry {
    pub roles: BTreeMap<String, RolePlugin>,
}

#[derive(Debug, Clone)]
pub(crate) struct RolePlugin {
