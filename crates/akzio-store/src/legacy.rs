//! Legacy persistence implementation awaiting owner-phase replacement.
//!
//! This is a temporary migration island for the old document/task store. New
//! runtime code must use the crate-root V2Store instead. SQL tables and blob
//! paths stay implementation details so callers cannot create competing state
//! models.
