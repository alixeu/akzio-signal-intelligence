...
fn validate_gate_lifecycle_events(
    ...
    let rows = statement.query_map(
        params![
            ...
            LifecycleEventType::ExecutionCancelCommitted.as_str(),
            LifecycleEventType::ExecutionCancelRecovered.as_str(),
    ...
    for row in rows {
        ...
        let expected_kind = match event_type {
            ...
            | LifecycleEventType::ExecutionCancelRecovered => ArtifactKind::ExecutionCancel,
