...
pub use crate::store_v2::{
    ...
    SessionSlotReservation, ShadowPairCompletion, ShadowPairWriteResult, StoreAlert, StoreError,
    StoreMetrics, StoreResult as Result, StoredActiveAttempt, StoredContract, StoredEvent,
