...
impl AgentRegistry {
    ...
    pub fn builtin() -> Self {
        ...
        registry.register(AgentDefinition {
            ...
            phase: 1,
            prompt_path: "prompts/phase1/technical.md".into(),
            preflight_tool: Some("read_technical_snapshot".into()),
            default_tools: vec![],
            default_weight: 50.0,
            is_critical: true,
        });
        registry.register(AgentDefinition {
            ...
            phase: 1,
            prompt_path: "prompts/phase1/news_macro.md".into(),
            preflight_tool: Some("read_jin10_candidates".into()),
            default_tools: vec![],
            default_weight: 50.0,
            is_critical: true,
        });
