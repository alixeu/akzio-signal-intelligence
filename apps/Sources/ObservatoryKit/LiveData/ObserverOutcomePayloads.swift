...
struct ObserverOutcomeWindowPayload: Decodable, Sendable {
    ...
    let implementationEffectPpm: Int64?
    let initialValuationEffectPpm: Int64?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case implementationEffectPpm = "implementation_effect_ppm"
        case initialValuationEffectPpm = "initial_valuation_effect_ppm"
